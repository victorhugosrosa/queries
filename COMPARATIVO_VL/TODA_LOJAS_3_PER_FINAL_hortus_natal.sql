...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '20131202'
	DECLARE @DATA_P2_FIM_A AS DATE = '20131229'

	DECLARE @DATA_P2_INI_B AS DATE = '20141201'
	DECLARE @DATA_P2_FIM_B AS DATE = '20141228'
