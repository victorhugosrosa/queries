...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	DECLARE @DATA_P1_FIM_A AS DATE = '20131201'

	DECLARE @DATA_P1_INI_B AS DATE = '20140728'
	DECLARE @DATA_P1_FIM_B AS DATE = '20141130'
	...
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '20121231'
	DECLARE @DATA_P2_FIM_A AS DATE = '20130324'

	DECLARE @DATA_P2_INI_B AS DATE = '20131230'
	DECLARE @DATA_P2_FIM_B AS DATE = '20140323'
	
	DECLARE @NUM_SEM_P2 AS INT = 12
	
	-- ----------------------------------------------------------------
	-- P3
	-- ----------------------------------------------------------------
	DECLARE @DATA_P3_INI_A AS DATE = '20131230'
	DECLARE @DATA_P3_FIM_A AS DATE = '20140323'

	DECLARE @DATA_P3_INI_B AS DATE = '20141229'
	DECLARE @DATA_P3_FIM_B AS DATE = '20150322'
	
	DECLARE @NUM_SEM_P3 AS INT = 12
