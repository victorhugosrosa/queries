...
BEGIN
	...
	BEGIN
		...
		-- -------------------------------------------------------------------------------------	
			...
			EXEC BI.DBO.[CARGA_BI_VENDA_PRODUTO_POR_LOJA] @DATA, @DATA, @COD_LOJA	
...
EXEC BI.DBO.[CARGA_BI_VENDA_DEPARTAMENTO] @DATA_INI, @DATA_FIM
EXEC BI.DBO.[CARGA_BI_VENDA_SECAO] @DATA_INI, @DATA_FIM
EXEC BI.DBO.[CARGA_BI_VENDA_GRUPO] @DATA_INI, @DATA_FIM
