...
--(1,2,3,6,9,13,12,18,17,20),21,22,23,24,30,25,27,31,29
-- -------------------------------------------------------------------------------------------------------------------------------------------
-- MAIN TABLE
-- -------------------------------------------------------------------------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- P1
	-- ----------------------------------------------------------------
	DECLARE @DATA_P1_INI_A AS DATE = '2014-03-01'
	DECLARE @DATA_P1_FIM_A AS DATE = '2014-04-05'

	DECLARE @DATA_P1_INI_B AS DATE = '2015-03-01'
	DECLARE @DATA_P1_FIM_B AS DATE = '2015-04-05'

	DECLARE @NUM_SEM_P1 AS INT = 1
	
	-- ----------------------------------------------------------------
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '2015-03-01'
	DECLARE @DATA_P2_FIM_A AS DATE = '2015-04-05'

	DECLARE @DATA_P2_INI_B AS DATE = '2016-03-01'
	DECLARE @DATA_P2_FIM_B AS DATE = '2016-04-05'
	
	DECLARE @NUM_SEM_P2 AS INT = 1
