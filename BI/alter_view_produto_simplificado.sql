USE [AX2009_INTEGRACAO]
GO

/****** Object:  View [dbo].[TAB_PRODUTO_SIMPLIFICADO]    Script Date: 01/22/2014 12:42:19 ******/
SET ANSI_NULLS ON
GO
...
--select * from [TAB_PRODUTO] where cod_produto= 17
ALTER VIEW   [dbo].[TAB_PRODUTO_SIMPLIFICADO]	  
as
 SELECT  DISTINCT
PROD.itemid	
