...
-- VARIABLES
-- -------------------------------------------------------------------------------------------------------------------------------------------
	DECLARE @DATA_P1_INI_A AS DATE = '20131028'
	DECLARE @DATA_P1_FIM_A AS DATE = '20131201'

	DECLARE @DATA_P1_INI_B AS DATE = '20141027'
	DECLARE @DATA_P1_FIM_B AS DATE = '20141130'

	DECLARE @DATA_P2_INI_A AS DATE = '20130729'
	DECLARE @DATA_P2_FIM_A AS DATE = '20131027'

	DECLARE @DATA_P2_INI_B AS DATE = '20140728'
	DECLARE @DATA_P2_FIM_B AS DATE = '20141026'
	
	DECLARE @NUM_SEM_P1 AS INT = 5
	DECLARE @NUM_SEM_P2 AS INT = 13
