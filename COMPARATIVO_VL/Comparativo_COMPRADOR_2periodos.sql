...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	DECLARE @DATA_P1_FIM_A AS DATE = '20130421'

	DECLARE @DATA_P1_INI_B AS DATE = '20131230'
	DECLARE @DATA_P1_FIM_B AS DATE = '20140420'

	DECLARE @NUM_SEM_P1 AS INT = 16
	
	-- ----------------------------------------------------------------
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '20131230'
	DECLARE @DATA_P2_FIM_A AS DATE = '20140420'

	DECLARE @DATA_P2_INI_B AS DATE = '20141229'
	DECLARE @DATA_P2_FIM_B AS DATE = '20150419'
	
	DECLARE @NUM_SEM_P2 AS INT = 16
...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	FROM
		@TAB_VENDA_SECAO AS MAIN
			...
			ON 1 = 1
			AND MAIN.COD_USUARIO = T.COD_USUARIO
