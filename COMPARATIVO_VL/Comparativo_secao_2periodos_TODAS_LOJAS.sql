...
WHERE 1 = 1
	...
	AND COD_LOJA in (1,2,3,6,9,13,12,18,17,20)
ORDER BY
	VP.COD_LOJA
	,H.NO_DEPARTAMENTO
...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '20140106'
	DECLARE @DATA_P2_FIM_A AS DATE = '20140209'

	DECLARE @DATA_P2_INI_B AS DATE = '20150105'
	DECLARE @DATA_P2_FIM_B AS DATE = '20150208'
...
-- -------------------------------------------------------------------------------------------------------------------------------------------		
	...
	WHERE 1 = 1
		AND VS.COD_LOJA in (1,2,3,6,9,13,12,18,17,20)
	ORDER BY
		NO_DEPARTAMENTO
		,NO_SECAO
