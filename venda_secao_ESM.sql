...
SELECT
	...
	,BI.dbo.fn_FormataVlr_Excel(SUM(VP.VALOR_TOTAL) / @QTD_SEMANAS) AS VLR_VENDA
...
WHERE 1=1
	AND CONVERT(DATE,VP.DATA) BETWEEN CONVERT(DATE,'20141107') AND CONVERT(DATE,'20141130')
	AND VP.COD_LOJA IN (27,3,2,9,1)
GROUP BY
	VP.COD_LOJA
	,L.NO_LOJA
	,CP.PNP
