...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	-- P1
	-- ----------------------------------------------------------------
	DECLARE @DATA_P1_INI_A AS DATE = '20130729'
	DECLARE @DATA_P1_FIM_A AS DATE = '20131027'

	DECLARE @DATA_P1_INI_B AS DATE = '20140728'
	DECLARE @DATA_P1_FIM_B AS DATE = '20141026'

	DECLARE @NUM_SEM_P1 AS INT = 13
	
	-- ----------------------------------------------------------------
	-- P2
	-- ----------------------------------------------------------------
	DECLARE @DATA_P2_INI_A AS DATE = '20131028'
	DECLARE @DATA_P2_FIM_A AS DATE = '20131201'

	DECLARE @DATA_P2_INI_B AS DATE = '20141027'
	DECLARE @DATA_P2_FIM_B AS DATE = '20141130'
	...
	-- P3
	-- ----------------------------------------------------------------
	DECLARE @DATA_P3_INI_A AS DATE = '20131202'
	DECLARE @DATA_P3_FIM_A AS DATE = '20131215'

	DECLARE @DATA_P3_INI_B AS DATE = '20141201'
	DECLARE @DATA_P3_FIM_B AS DATE = '20141214'
	
	DECLARE @NUM_SEM_P3 AS INT = 2
...
-- -------------------------------------------------------------------------------------------------------------------------------------------
	...
	SELECT
		VS.PNP
		,SUM(VENDA_P3_B) / SUM(VENDA_P3_A) AS AVG_PNP
	FROM
		@TAB_VENDA_SECAO as VS
	GROUP BY
		VS.PNP
